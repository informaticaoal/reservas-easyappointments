...
<head>
    ...
    <title><?= vars('page_title') ?? lang('calendar') ?> - Solo lectura | Easy!Appointments</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?= asset_url('assets/css/layouts/calendar_readonly_layout.css') ?>">
...
<main class="flex-shrink-0">
    ...
    <?php component('calendar_readonly_header', ['user_display_name' => vars('user_display_name')]); ?>
